...
```
   ...
   BACKGROUND
      Recommended input files ("left.HKL" and "right.HKL") are produced by the INTEGRATE step of XDS (INTEGRATE.HKL). 
   ...
   MANUSCRIPT:
      K. Składanowska, Y. Bloch et al. (2022) <a href="https://doi.org/10.2139/ssrn.4120771">link</a>
```
